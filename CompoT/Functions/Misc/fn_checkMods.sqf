...
if (isClass (configfile >> "CfgPatches" >> "mm_bank")) then {CT_var_mods pushBack "mattaust buildings"};
if (isClass (configfile >> "CfgPatches" >> "brg_africa")) then {CT_var_mods pushBack "BRG African Foliage"};
if (
